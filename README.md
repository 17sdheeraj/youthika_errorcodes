...
- Generates individual HTML pages for dozens of HTTP status codes
- Uses emojis and friendly messages for a better user experience
- Easy to customize with your own `template.html`
- Simple to run — just execute the script and you're good to go


You can add them and make them work in your website like mine using `vercel.json`